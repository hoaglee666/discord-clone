...
export const ServerSearch = ({
    ...
    return (
        <>
            ...
            >
                <CommandInput placeholder="Search all channels and members" className="focus:outline-none focus:ring-0"/>
                <CommandList>
                    <CommandEmpty>
                        No results found
                    </CommandEmpty>
                        ...
                        return (
                            <CommandGroup key={label} heading={label}>
                                {data?.map(({id, icon, name}) => {
                                    return (
                                        <CommandItem className="font-semibold text-sm text-zinc-500
